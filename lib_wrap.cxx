...
SWIGINTERN PyObject *_wrap_returnSanya(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  string result;
  
  if (!SWIG_Python_UnpackTuple(args, "returnSanya", 0, 0, 0)) SWIG_fail;
  result = returnSanya();
  resultobj = SWIG_NewPointerObj((new string(result)), SWIGTYPE_p_string, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_return1(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!SWIG_Python_UnpackTuple(args, "return1", 0, 0, 0)) SWIG_fail;
  result = (int)return1();
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "returnSanya", _wrap_returnSanya, METH_NOARGS, NULL},
	 { "fact", _wrap_fact, METH_O, NULL},
	 { "return1", _wrap_return1, METH_NOARGS, NULL},
